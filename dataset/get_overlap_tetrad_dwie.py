...
print(max_label_num)
print(len(strict_overlap_list), strict_overlap_list, )  # 477
print()
print(len(overlap_list), overlap_list, )  # 1046
print()
print(len(overlap_entity_pair_list), overlap_entity_pair_list, )  # 477

print(len(overlap_list_2), len(overlap_entity_pair_list_2))  # 770   385
print(len(overlap_list_3), len(overlap_entity_pair_list_3))  # 276    92
print(len(overlap_list_4), len(overlap_entity_pair_list_4))  
